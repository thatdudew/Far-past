...
public class OuranoRenderer extends GeoEntityRenderer<OuranoEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, OuranoEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
