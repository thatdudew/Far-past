...
public class StegosaurusEntity extends PathfinderMob implements GeoEntity {
	...
	protected void defineSynchedData(SynchedEntityData.Builder builder) {
		...
		builder.define(TEXTURE, "pa_stegosauruss");
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(FarPastModEntities.STEGOSAURUS.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
