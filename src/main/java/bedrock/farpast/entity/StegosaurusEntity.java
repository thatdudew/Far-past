...
public class StegosaurusEntity extends PathfinderMob implements GeoEntity {
	...
	public StegosaurusEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(FarPastModEntities.STEGOSAURUS.get(), world);
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "pa_stegosauruss");
	}
	...
	public static void init() {
		SpawnPlacements.register(FarPastModEntities.STEGOSAURUS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	private PlayState movementPredicate(AnimationState event) {
		if (this.animationprocedure.equals("empty")) {
			if ((event.isMoving() || !(event.getLimbSwingAmount() > -0.15F && event.getLimbSwingAmount() < 0.15F))
				...
				return event.setAndContinue(RawAnimation.begin().thenLoop("animation.stegosaurus.walk"));
			}
			return event.setAndContinue(RawAnimation.begin().thenLoop("animation.stegosaurus.stand"));
		}
